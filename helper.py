...
#
# Orgininally written by James Whitfield and AJ Cressman for Physics 116: 
# *Graduate Quantum Information Science* in Spring 2022 at Dartmouth College.
# Based on AWS Quantum Technologies blogpost "Bernoulli Line and the Bloch Sphere"
# by Kanav Setia, James Whitfield, and Tyler Takeshita.
#
# Blogpost links
#   (https://aws.amazon.com/blogs/quantum-computing/bernoulli-line-and-the-bloch-sphere/)
#   (https://www.qbraid.com/blog/partner-post-aws-quantum-technologies-blog-bernoulli-line-and-the-bloch-sphere-visualizing-probability-and-quantum-states))
...
def plot_qubit_state(qubit_biases,computed_uncertainties=None):
    ...
    Args:
        qubit_biases                Dictionaries with keys "x", "y", "z". 
                                    Values should be normalized to unit vector length or less.
